...
We welcome all contributions to Structural_Effect_of_Oncogenic_Mutations!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/augustineonyema/structural_effect_of_oncogenic_mutations/issues)
...
The second two options both involve making a [pull request](https://github.com/augustineonyema/structural_effect_of_oncogenic_mutations/pulls) .
